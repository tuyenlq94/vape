<?php
$title_vape = rwmb_meta('thuong_hieu_vape');
$content_vape = rwmb_meta('content_vape');
$sub_vape = rwmb_meta('sub_vape');
$vapes = rwmb_meta('group_vape');
?>
